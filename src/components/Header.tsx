  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center h-16">
      ...
      <Link to="/" className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">KOPERASI KAMAPA</h1>
      ...
      <div className="md:hidden border-t border-gray-200">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <Link
            to="/portal-anggota"
            onClick={() => setIsMenuOpen(false)}
            className="block bg-primary-600 text-white px-3 py-2 rounded-lg text-base font-medium hover:bg-primary-700 transition-colors duration-200 mx-3 mt-4"
          >
            Portal Anggota
          </Link>
        </div>
